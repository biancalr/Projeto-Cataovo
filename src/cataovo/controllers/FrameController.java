...
public interface FrameController {
    ...
    /**
     * Chooses the format to paint the {@link cataovo.entities.Frame Frame}
     * whether is a dot or a rectangle
     *
     ...
     * @see
     * cataovo.utils.frameUtils.FrameActionsUtils#drawCircle(cataovo.opencvlib.wrappers.PointWrapper)
     * @see
     * cataovo.utils.frameUtils.FrameActionsUtils#drawRectangle(cataovo.opencvlib.wrappers.RectWrapper)
     */
    ...
    /**
     * Paint a collection of {@link cataovo.entities.Region Region} and
     * {@link cataovo.entities.Point Point} in a
     * {@link cataovo.entities.Frame Frame}.
     *
     * @param currentFrame
     ...
     * @see
     * cataovo.controllers.FileReaderController#getPointsInFrameFile(java.lang.String,
     * java.lang.String)
     * @see
     * cataovo.controllers.FileReaderController#getRegionsInFrameFile(java.lang.String,
     * java.lang.String)
     */
    ...
    /**
     * Captures a subframe in the current selected
     * {@link cataovo.entities.Region} to focus in the application.
     *
     ...
     * @throws DirectoryNotValidException
     * @see
     * cataovo.utils.frameUtils.FrameActionsUtils#captureSubframe(cataovo.entities.Point,
     * cataovo.entities.Point)
     */
